...
```Bash
uv run python -m cfdmod.altimetry \
   --csv {CSV_PATH} \
...
You can also use the example notebooks, found in [Altimetry from probes](altimetry_from_probes.ipynb) and [Generic use of altimetry](altimetry_from_coordinates.ipynb)
